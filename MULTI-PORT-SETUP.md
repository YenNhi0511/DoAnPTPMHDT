...
1. **Mỗi port chỉ hiển thị routes của role tương ứng:**
   - Port 3000 (ADMIN): Chỉ có routes admin, không có careers, không có recruiter routes
...
Nếu gặp lỗi "Port 3000/3001/3002 is already in use":
...
{
  "scripts": {
    "start:admin": "cross-env PORT=3000 REACT_APP_ROLE=ADMIN react-scripts start",
...
- `REACT_APP_ROLE=ADMIN` cho port 3000
