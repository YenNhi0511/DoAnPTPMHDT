"""
Script để tạo CV mẫu (PDF) cho TẤT CẢ các ngành nghề trong hệ thống
Cần cài: pip install reportlab faker
Chạy: python generate_all_cvs.py
"""
import os
import re
...
def create_cv(filename, name, email, phone, experience_years, skills, job_title, job_group, profession):
    ...
    if job_group in ['Công nghệ Thông tin', 'Kế toán/Tài chính']:
...
# Định nghĩa tất cả các vị trí cần tạo CV
job_positions = [
    # Kinh doanh/Bán hàng
