    ...
    <div>
      ...
      <div className="mb-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-700">Cập nhật thông tin công ty</span>
            <span className="ml-auto text-gray-600">→</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-5 h-5 rounded-full border-2 border-gray-300"></div>
            <span className="text-sm text-gray-700">Xác thực Giấy đăng ký doanh nghiệp</span>
            <span className="ml-auto text-gray-600">→</span>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-700">Email không thể thay đổi</p>
        </div>
